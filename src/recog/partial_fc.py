...
class PartialFC(torch.nn.Module):
    ...
    def __init__(
        ...
        self.margin_loss: Callable = margin_loss
    ...
    def forward(
        ...
        _list_embeddings = AllGatherFunc.apply(local_embeddings, *_gather_embeddings)
        ...
        with torch.cuda.amp.autocast(self.fp16):
            ...
            logits = linear(embeddings, norm_weight_activated)
        if self.fp16: 
            logits = logits.float()
